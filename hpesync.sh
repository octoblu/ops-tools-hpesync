...
usage(){
  echo "USAGE: hpesync [options] <dump/gd/gload/l/printfs/pf/printetcd/pe> <project-name>"
  echo ""
  echo "example: hpesync load governator-service"
